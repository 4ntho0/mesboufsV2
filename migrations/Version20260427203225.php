 ...
 */
final class Version20260427203225 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE version (id INT AUTO_INCREMENT NOT NULL, version VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE ingredient CHANGE quantite quantite DOUBLE PRECISION NOT NULL');
        ...
        $this->addSql('ALTER TABLE note CHANGE recette_id recette_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE note CHANGE recette_id recette_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE ingredient CHANGE quantite quantite INT NOT NULL');
