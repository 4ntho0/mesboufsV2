 ...
 */
final class Version20260426201825 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE unitee (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE ingredient ADD unitee_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_6BAF7870D3EB8572 ON ingredient (unitee_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_6BAF7870D3EB8572 ON ingredient');
        $this->addSql('ALTER TABLE ingredient DROP unitee_id');
